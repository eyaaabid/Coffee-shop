...
import com.example.projetandroid.Adapter.CoffeeAdapter;
import com.example.projetandroid.MVVM.CoffeeViewModel;
import com.example.projetandroid.Model.CartModel;
import com.example.projetandroid.Model.CoffeeModel;
import com.example.projetandroid.AllCoffeeListFragmentDirections;
import com.example.projetandroid.Model.CoffeeModel;
...
public class AllCoffeeListFragment extends Fragment implements CoffeeAdapter.GetOneCoffee {
    ...
    public void onViewCreated(View view,  Bundle savedInstanceState) {
        ...
        viewModel.getCoffeeList().observe(getViewLifecycleOwner(), new Observer<List<CoffeeModel>>() {
            @Override
            public void onChanged(List<CoffeeModel> cofeModels) {

                mAdapter.setCoffeeModelList(cofeModels);
